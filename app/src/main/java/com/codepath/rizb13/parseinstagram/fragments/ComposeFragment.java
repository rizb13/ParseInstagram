...
import com.codepath.rizb13.parseinstagram.LoginActivity;
import com.codepath.rizb13.parseinstagram.MainActivity;
    ...
    private void savePost(String description, ParseUser parseUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                ...
                Log.d(TAG, "Success!");
                Toast.makeText(getContext().getApplicationContext(), "Post Saved Successfully!", Toast.LENGTH_LONG).show();
